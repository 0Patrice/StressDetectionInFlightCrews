...
def startStopButton(n_clicks, disabled_state):
    ...
    if n_clicks % 2 == 0:
        ...
        dataFile = f"{timeNow.month}_{timeNow.day}_{timeNow.hour}_{timeNow.minute}_CP_DA.csv"

        dataFileConfirmed = f"{timeNow.month}_{timeNow.day}_{timeNow.hour}_{timeNow.minute}_CP_DConf.csv"
